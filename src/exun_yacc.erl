...
yeccpars2_10(_S, Cat, Ss, Stack, T, Ts, Tzr) ->
 ...
 yeccgoto_main(hd(Ss), Cat, Ss, NewStack, T, Ts, Tzr).
...
-compile({nowarn_unused_function,  yeccgoto_main/7}).
yeccgoto_main(0, Cat, Ss, Stack, T, Ts, Tzr) ->
 yeccpars2_8(8, Cat, Ss, Stack, T, Ts, Tzr).

-dialyzer({nowarn_function, yeccgoto_matrix/7}).
-compile({nowarn_unused_function,  yeccgoto_matrix/7}).
...
-compile({nowarn_unused_function,  yeccgoto_mmm/7}).
...
-compile({nowarn_unused_function,  yeccgoto_msm/7}).
...
-compile({nowarn_unused_function,  yeccgoto_uexpr/7}).
...
-compile({nowarn_unused_function,  yeccgoto_vector/7}).
...
-compile({nowarn_unused_function,  yeccgoto_vectors/7}).
...
yeccpars2_6_(__Stack0) ->
 [___1 | __Stack] = __Stack0,
 [begin
              {{m, mult}, lists:sort(___1)}
  end | __Stack].

-compile({inline,yeccpars2_7_/1}).
-dialyzer({nowarn_function, yeccpars2_7_/1}).
-compile({nowarn_unused_function,  yeccpars2_7_/1}).
-file("src/exun_yacc.yrl", 55).
...
yeccpars2_23_(__Stack0) ->
 ...
 [begin
                              {{vector, length(___2)}, lists:reverse(___2)}
  end | __Stack].
...
yeccpars2_45_(__Stack0) ->
 [___3,___2,___1 | __Stack] = __Stack0,
 [begin
                            {{raw, length(___2), vlen(lists:nth(1,___2))}, lists:reverse(___2),[],[]}
  end | __Stack].
